...
export const translations = {
  ...
  "admin.common.refresh": { kz: "Жаңарту", ru: "Обновить", en: "Refresh" },
  "admin.common.view": { kz: "Қарау", ru: "Просмотр", en: "View" },
  ...
  "admin.search.placeholder": { kz: "Іздеу...", ru: "Поиск...", en: "Search..." },
  ...
  "admin.confirm.delete.title": { kz: "Таңдалғанды жою керек пе?", ru: "Удалить выбранное?", en: "Delete selected?" },
  "admin.confirm.delete.description": { kz: "{count} элемент жойылады.", ru: "Будет удалено {count} элементов.", en: "{count} items will be deleted." },
  ...
  "admin.questions.search": { kz: "Сұрақ мәтіні бойынша іздеу...", ru: "Поиск по тексту вопроса...", en: "Search questions..." },
  "admin.questions.allSubjects": { kz: "Барлық пәндер", ru: "Все предметы", en: "All subjects" },
  "admin.questions.filter.allSubjects": { kz: "Барлық пәндер", ru: "Все предметы", en: "All subjects" },
  "admin.questions.allDifficulty": { kz: "Кез келген қиындық", ru: "Любая сложность", en: "Any difficulty" },
  "admin.questions.generateAi": { kz: "ЖИ-мен жасау", ru: "Сгенерировать ИИ", en: "Generate with AI" },
  ...
  "admin.questions.subject": { kz: "Пән", ru: "Предмет", en: "Subject" },
  "admin.questions.question": { kz: "Сұрақ", ru: "Вопрос", en: "Question" },
  "admin.questions.answer": { kz: "Жауап", ru: "Ответ", en: "Answer" },
  "admin.questions.difficulty": { kz: "Қиындық", ru: "Сложность", en: "Difficulty" },
  "admin.questions.actions": { kz: "Әрекеттер", ru: "Действия", en: "Actions" },
  "admin.questions.table.question": { kz: "Сұрақ", ru: "Вопрос", en: "Question" },
  "admin.questions.table.answer": { kz: "Жауап", ru: "Ответ", en: "Answer" },
  "admin.questions.table.difficulty": { kz: "Қиындық", ru: "Сложность", en: "Difficulty" },
  "admin.questions.form.subject": { kz: "Пән *", ru: "Предмет *", en: "Subject *" },
  "admin.questions.difficulty.easy": { kz: "Жеңіл", ru: "Лёгкий", en: "Easy" },
  ...
  "common.refresh": { kz: "Жаңарту", ru: "Обновить", en: "Refresh" },
  "common.view": { kz: "Қарау", ru: "Просмотр", en: "View" },
  "common.edit": { kz: "Өңдеу", ru: "Редактировать", en: "Edit" },
  "common.delete": { kz: "Жою", ru: "Удалить", en: "Delete" },
  "common.difficulty.easy": { kz: "Жеңіл", ru: "Лёгкий", en: "Easy" },
  "common.difficulty.medium": { kz: "Орташа", ru: "Средний", en: "Medium" },
  "common.difficulty.hard": { kz: "Қиын", ru: "Сложный", en: "Hard" },
  "common.sort.newest": { kz: "Алдымен жаңалары", ru: "Сначала новые", en: "Newest first" },
  "common.sort.oldest": { kz: "Алдымен ескілері", ru: "Сначала старые", en: "Oldest first" },
  "common.sort.idAsc": { kz: "ID бойынша", ru: "По ID", en: "By ID" },
